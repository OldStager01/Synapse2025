  ...
  return (
    <button
      ...
      className={cn(
        ...
        // Darker red background for better visibility
        "bg-[linear-gradient(#C40000,#C40000),linear-gradient(#C40000_50%,rgba(196,0,0,0.6)_80%,rgba(196,0,0,0)),linear-gradient(90deg,hsl(var(--color-1)),hsl(var(--color-5)),hsl(var(--color-3)),hsl(var(--color-4)),hsl(var(--color-2)))]",
        // Dark mode variant with even darker red
        "dark:bg-[linear-gradient(#A00000,#A00000),linear-gradient(#A00000_50%,rgba(160,0,0,0.6)_80%,rgba(160,0,0,0)),linear-gradient(90deg,hsl(var(--color-1)),hsl(var(--color-5)),hsl(var(--color-3)),hsl(var(--color-4)),hsl(var(--color-2)))]",
        className
      )}
      {...props}
    >
