...
export default function MarvelCarousel() {
  ...
  return (
    <div className="w-full h-full mt-20 flex flex-col items-center justify-center bg-black py-12 px-4 overflow-hidden">
          ...
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight mb-4 uppercase relative inline-block">
              <span className="relative z-10">
                ...
                <span className="text-white">GLIMPSES</span>
              </span>
              {/* <span className="absolute -bottom-1 left-0 right-0 h-3 bg-gradient-to-r from-white via-amber-500 to-red-500 opacity-70 blur-sm"></span> */}
            </h2>
